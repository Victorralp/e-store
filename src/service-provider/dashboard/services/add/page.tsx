            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="text-sm text-gray-600 mb-4">
                  Upload images to showcase your service. High-quality images help customers understand what they'll receive.
                </div>
                
                <CloudinaryUploadWidget
                  buttonText="Upload Service Images"
                  onUploadSuccess={(publicId, url, alt) => {
                    const newImage = {
                      publicId,
                      url,
                      alt: alt || formData.name || 'Service image'
                    }
                    setFormData(prev => ({
                      ...prev,
