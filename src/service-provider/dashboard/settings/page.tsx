...
export default function ServiceProviderSettingsPage() {
  ...
  const handleSave = async (section: string) => {
    ...
    setIsLoading(false)
    alert(`Your ${section} settings have been updated successfully.`)
  }
  ...
  return (
    <ServiceProviderLayout title="Settings" description="Manage your service provider profile and preferences">
