...
import comLogog from "../a/demo_logo.png"
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center justify-between py-2">
              ...
              <ul className="flex items-center">
                    ...
                    {item.dropdown && (
                      <div
                        className={`absolute top-full left-0 shadow-xl rounded-md w-64 z-50 transition-all duration-200 dropdown-menu-container
                          bg-white border border-gray-200 max-h-60 overflow-hidden ${activeDropdown === item.title
                ...
                <li className="relative">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`ml-1 h-4 w-4 transition-transform duration-200 ${activeDropdown === "more-nav" ? "rotate-180" : ""
                        } text-gray-500`}
                    />
                  </div>
                  ...
                  <div
                    className={`absolute top-full right-0 shadow-lg rounded-b-lg w-40 z-30 transition-all duration-300 dropdown-menu-container
                      bg-white border-t-2 border-green-500 ${activeDropdown === "more-nav"
                ...
                {user ? (
                  <div className="relative dropdown-menu-container">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`ml-1 h-4 w-4 transition-transform duration-200 ${activeDropdown === "profile" ? "rotate-180" : ""
                          } text-gray-500`}
                      />
                    </div>
                    ...
                    <div
                      className={`absolute top-full right-0 shadow-lg rounded-lg w-48 z-30 transition-all duration-300
                        bg-white border-t-2 border-green-500 ${activeDropdown === "profile"
                          ? "opacity-100 translate-y-0 visible"
                          : "opacity-0 -translate-y-2 invisible"
                        }`}
                    >
            ...
            <div className="flex md:hidden items-center space-x-3">
              ...
              <Link to="/cart" className="relative hover:text-green-600 p-1">
                <ShoppingCart className="h-6 w-6 text-gray-700" />
                <ClientOnly>
                  {getTotalItems() > 0 && (
                    <span className="absolute -top-1 -right-1 bg-green-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
      ...
      <div
        className={`fixed top-[calc(7.5rem+1px)] left-0 right-0 md:hidden border-t shadow-lg transform transition-all duration-300 max-h-[80vh] overflow-y-auto
          bg-white border-t border-gray-200 z-40 ${mobileMenuOpen
            ...
            {mainNavItems.map((item) => (
              <li key={item.title} className="py-2">
                {!item.dropdown ? (
                  <Link
                    to={item.href}
                    className={`flex items-center py-2 space-x-2 ${pathname === item.href
                  ...
                  <div>
                    ...
                    >
                      <div
                        className={`flex items-center space-x-2 ${pathname === item.href
                          ? "text-green-600 font-medium"
                          : "text-gray-700"
                          }`}
                      >
                    ...
                    <div
                      className={`overflow-hidden transition-all duration-200 ${activeDropdown === item.title
